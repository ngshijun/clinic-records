...
/**
 * Compute due_at as `performedOn + days` at 08:00 Malaysia time, returned
 * as a UTC ISO string. Aligns with the first of three daily notification
 * slots (08:00 / 12:00 / 16:00 MY) so pushes can begin the moment the
